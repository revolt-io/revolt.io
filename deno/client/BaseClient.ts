...
import { REST, Endpoints } from '../rest/index.ts'
import type { Channel, DMChannel, GroupChannel, Role, ServerMember, TextChannel, User, Server, Message } from '../structures/index.ts'
